...
& "C:\Program Files (x86)\MSBuild\12.0\Bin\MSBuild.exe" "$SourcesDirectory\GenericSolution\GenericTestCases.sln" /t:rebuild /p:Configuration=Release
#$BuildError1=$LASTEXITCODE

Robocopy.exe "$SourcesDirectory\GenericSolution\GenericTestCases\bin\Release" "$SourcesDirectory\Drop"
